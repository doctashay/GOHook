...
public:
	...
	{
		typedef void(__thiscall* GetScreenSize_t)(PVOID, const char*);
		Utilities::GetVFunction<GetScreenSize_t>(this, 114)(this, szCmdString);
	}
...
public:
	...
	studiohdr_t* GetStudiomodel(const void* mod)
	{
		...
		return Utilities::GetVFunction<GetStudiomodel_t>(this, 32)(this, mod);
	}
};
